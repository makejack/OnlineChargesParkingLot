...
namespace OnlineChargesParkingLot.Model
{
    ...
    {
        public ExitModel(string licensePlateNumber, DateTime identificationTime, LicensePlateTypes licensePlateType, Color licensePlateColor, Image pImage, Image vImage)
        {
